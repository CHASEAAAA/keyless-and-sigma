...
local Window = Rayfield:CreateWindow({
    ...
    KeySettings = {
       ...
       Key = {"KOBRANPERM"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
    }
 })
...
elseif game.GameId==5750914919 then
    ...
    local Button = gameTab:CreateButton({
       ...
       Callback = function()
         loadstring(game:HttpGet("https://raw.githubusercontent.com/KOBRANHUB/lucky-block/refs/heads/main/x/lua",true))()
       end, 
    })
...
elseif game.GameId==279565647 then 
   ...
   local Button = gameTab:CreateButton({
      ...
      Callback = function()
         loadstring(game:HttpGet("https://raw.githubusercontent.com/KOBRANHUB/lucky-block/refs/heads/main/lucky%20block.lua",true))()
      end, 
   })
...
elseif game.GameId==113491250 then
   local gameTab = Window:CreateTab("Phantom Forces", 4483362458) -- Title, Image
   local Section = gameTab:CreateSection("Phantom Forces")

   local Button = gameTab:CreateButton({
      Name = "Neptune Hub (aimbot dont work on solara)",
      Callback = function()
